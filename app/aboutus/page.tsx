...
export default function ClientSide() {
  const [postData, setPostData] = useState<any>({ data: null, users: null });
  const [comments, setCommentsData] = useState<any>({
    data: null,
    users: null,
  });
  ...
  if (!postData.data || !comments.data) {
    return (
